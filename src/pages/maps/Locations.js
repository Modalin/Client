...
export default class App extends Component {
  ...
  getAddress = () => {
    fetch("https://maps.googleapis.com/maps/api/geocode/json?address=" + this.state.region.latitude + "," + this.state.region.longitude + "&key=" + "AIzaSyBmfp6qE_0XHKP_JI6jWe_vxlB_utq71Z8")
  ...
  onHandleSelect = () => {
    ...
    // })
    this.props.navigation.navigate('create business', { lat: this.state.region.latitude, long: this.state.region.longitude, address: this.state.userLocation })
