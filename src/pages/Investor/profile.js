    ...
    <View style={[investor_style.container_home]}>
        <View style={[investor_style.container,investor_style.bar_,{flexDirection: "row", paddingBottom: 20}]}>
          ...
          <View style={[{justifyContent: "center", marginHorizontal: 20}]}>
            {
              editStatus ? <TextInput style={{ borderBottomWidth:1, borderBottomColor: "#aeaeae", paddingVertical: 5}} onChangeText={(text)=> setName(text)} value={name}>{tokenInvestor.name ? tokenInvestor.name : ''}</TextInput> :
